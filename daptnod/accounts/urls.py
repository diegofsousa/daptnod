...
from .views import login, logout, RegisterView, UpdateUserView, UpdatePasswordView, me, offer_retry_sending_email, retry_sending_email, activation_account
...
urlpatterns = [
    ...
    path('signup/activation/code/<str:hashlink>', activation_account, name='activation'),
